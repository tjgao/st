 ...
 */
static char *font = "JetBrainsMono Nerd Font:size=20:antialias=true:autohint=true";
//static char *font = "TerminessTTF Nerd Font:size=18:antialias=true:autohint=true";
